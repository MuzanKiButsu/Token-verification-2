...
TUT_VID = os.environ.get("TUT_VID", "https://t.me/+QUB56VK92YY2YWM1") # shareus ka tut_vid he 

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002216223271"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5461616767").split()):
        ADMINS.append(int(x))
except ValueError:
